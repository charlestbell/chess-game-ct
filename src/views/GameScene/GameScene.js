...
export default class Scene extends Component {
  ...
  componentDidMount() {
    ...
    // Enable for Crypto Functionality
    ...
    var performMove = (moveResult) => {
      ...
      // Check chess piece on the target position: each action performed at that time
      ...
      // Check if pawn arrived last spuare
